        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li><Link href="/terminos-y-condiciones" className="text-sm no-underline transition-opacity hover:opacity-100" style={{ color: "rgba(255,255,255,0.75)" }}>Términos y Condiciones</Link></li>
